...
namespace DAL
{
    ...
    public class ConexionDb
    {
        ...
        public ConexionDb()
        {
            ...
            // Me da error el configurationManager lo use al modo antiguo
            con = new SqlConnection("Data Source=DESKTOP-4C3B5SF\\SQLEXPRESS;Initial Catalog=ParcialDb;Integrated Security=True");
            Cmd = new SqlCommand();
